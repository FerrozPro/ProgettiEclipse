...
public class MyNodeListIterator<T> implements MyIterator<T> {
	...
	// Se questo costruttore fosse privato, come abbiamo fatto per la
	// MyStaticInnerIterator, non potremmo
	// nemmeno invocarlo dai metodi di MyNodeList. Viceversa, se lo lasciamo
	// pubblico, chiunque può costruire questa classe.
	// Se vogliamo mantenere la filosofia del "non permettere a nessuno di costruire
	// un iteratore esplicitamente", allora il
	// massimo che possiamo fare è stringere la visibilità a package-private (che
	// in Java si fa non specificando alcuna keyword).
