...
public class OverloadTest {
	...
	public EssereVivente m(EssereVivente x) {
		return x;
	}

	public EssereVivente m(Animale x) {
		return x;
	}

	public EssereVivente m(Cane x) {
		return x;
	}

	// definiamo un altro metodo main che facciamo partire tramite la Run
	// Configuration di IntelliJ di nome OverloadTest
